package com.breezefsmsettdeycohomoeolab.features.logoutsync.presentation
...
import com.breezefsmsettdeycohomoeolab.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefsmsettdeycohomoeolab.features.billing.api.AddBillingRepoProvider
import com.breezefsmsettdeycohomoeolab.features.billing.model.AddBillingInputParamsModel
...
import com.breezefsmsettdeycohomoeolab.features.dashboard.presentation.ReasonDialog
...
import com.breezefsmsettdeycohomoeolab.features.document.model.AddEditDocumentInputParams
import com.breezefsmsettdeycohomoeolab.features.document.model.DocumentAttachmentModel
...
import com.breezefsmsettdeycohomoeolab.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefsmsettdeycohomoeolab.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefsmsettdeycohomoeolab.features.orderhistory.model.*
...
import com.breezefsmsettdeycohomoeolab.features.quotation.model.AddQuotInputModel
import com.breezefsmsettdeycohomoeolab.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmsettdeycohomoeolab.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefsmsettdeycohomoeolab.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefsmsettdeycohomoeolab.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefsmsettdeycohomoeolab.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefsmsettdeycohomoeolab.features.timesheet.model.AddTimeSheetInputModel
import com.breezefsmsettdeycohomoeolab.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefsmsettdeycohomoeolab.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefsmsettdeycohomoeolab.features.viewAllOrder.model.AddOrderInputProductList
...
import com.breezefsmsettdeycohomoeolab.MonitorService
import com.breezefsmsettdeycohomoeolab.MySingleton
...
import com.breezefsmsettdeycohomoeolab.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefsmsettdeycohomoeolab.features.login.model.GetConcurrentUserResponse
import com.breezefsmsettdeycohomoeolab.features.login.model.WhatsappApiData
import com.breezefsmsettdeycohomoeolab.features.performance.model.Gps_status_list
import com.breezefsmsettdeycohomoeolab.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefsmsettdeycohomoeolab.features.returnsOrder.ReturnProductList
import com.breezefsmsettdeycohomoeolab.features.returnsOrder.ReturnRequest
import com.breezefsmsettdeycohomoeolab.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmsettdeycohomoeolablogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmsettdeycohomoeolablogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmsettdeycohomoeolablogsample/log.zip").path);
